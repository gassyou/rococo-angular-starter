...
let users = [
  {
    ...
    role: 1,
    roleName: 'Admin0',
    lastLoginTime: '2020/01/01 12:01:00',
  ...
  },
  {
    ...
    role: 1,
    roleName: 'Admin9',
    lastLoginTime: '2020/01/01 11:01:00',
  ...
  },
  {
    ...
    role: 1,
    roleName: 'Admin8',
    lastLoginTime: '2020/01/01 10:01:00',
  ...
  },
  {
    ...
    role: 1,
    roleName: 'Admin7',
    lastLoginTime: '2020/01/01 09:01:00',
  ...
  },
  {
    ...
    role: 1,
    roleName: 'Admin6',
    lastLoginTime: '2020/01/01 08:01:00',
...
function checkRoleName(value: any, datasource: any[]) {
  ...
  if (value.id) {
    index = datasource.findIndex(x => {
      return x.id !== value.id && x.name === value.name;
    });
  } else {
    index = datasource.findIndex(x => {
...
function checkNewPw(value: any, datasource: any[]) {
  let user: any = datasource.filter(x => {
...
function checkMobile(value: any, datasource: any[]) {
  ...
  if (value.id) {
    index = datasource.findIndex(x => {
      return x.id !== value.id && x.mobile === value.mobile;
    });
  } else {
    index = datasource.findIndex(x => {
      return x.mobile === value.mobile;
    });
  }
